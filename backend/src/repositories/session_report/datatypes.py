...
class SessionReportCreate(BaseModel):
    ...
    questions: List[Dict[str, Any]] = Field(..., description="Perguntas e respostas no relatório")
...
class SessionReportUpdate(BaseModel):
    ...
    questions: Optional[List[Dict[str, Any]]] = Field(None, description="Perguntas e respostas no relatório")
